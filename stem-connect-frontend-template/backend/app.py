...
# UI thresholds (simple badge)ta
NEARBY_THRESHOLD_SEC   = int(os.getenv("NEARBY_THRESHOLD_SEC", "720"))   # 12 min
APPROACH_THRESHOLD_SEC = int(os.getenv("APPROACH_THRESHOLD_SEC", "480")) # 8 min
STOP_THRESHOLD_SEC     = int(os.getenv("STOP_THRESHOLD_SEC", "240"))      # 4 min

# Device thresholds (alert mapping)
ORIGIN_NEARBY_THRESHOLD     = int(os.getenv("ORIGIN_NEARBY_THRESHOLD", "720"))  # 12m
ORIGIN_APPROACH_THRESHOLD   = int(os.getenv("ORIGIN_APPROACH_THRESHOLD", "480"))# 8m
ORIGIN_STOP_THRESHOLD       = int(os.getenv("ORIGIN_STOP_THRESHOLD", "240"))     # 4m

DEST_NEARBY_THRESHOLD       = int(os.getenv("DEST_NEARBY_THRESHOLD", "720"))    #12m
DEST_APPROACH_THRESHOLD     = int(os.getenv("DEST_APPROACH_THRESHOLD", "480"))  # 8m
DEST_STOP_THRESHOLD         = int(os.getenv("DEST_STOP_THRESHOLD", "240"))      # 4m
